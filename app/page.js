  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-3xl flex-col gap-6 px-4 py-8 sm:px-6">
      <section className="rounded-3xl bg-white p-5 shadow-sm sm:p-8">
        <p className="text-sm font-semibold uppercase tracking-[0.2em] text-indigo-600">Issue #15</p>
        <h1 className="mt-2 text-3xl font-bold tracking-tight">OpenClaw Test 2 Fresh Task D</h1>
